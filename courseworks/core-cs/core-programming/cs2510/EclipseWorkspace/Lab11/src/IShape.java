...
/**
 * HtDC Lectures Lecture 5: Methods for unions of classes
 * 
...
/*
 * +----------------------------+ | IShape | +----------------------------+ |
 * double area() | | double distToOrigin() | | IShape grow(int) | | boolean
 * biggerThan(IShape) | | boolean contains(CartPt) |
 * +----------------------------+ | / \ --- |
 * ------------------------------------- | | +----------------------------+
 * +----------------------------+ | Circle | | Square |
 * +----------------------------+ +----------------------------+ +-| CartPt
 * center | +-| CartPt nw | | | int radius | | | int size | | | String color | |
 * | String color | | +----------------------------+ |
 * +----------------------------+ | | double area() | | | double area() | | |
 * double distToOrigin() | | | double distToOrigin() | | | IShape grow(int) | |
 * | IShape grow(int) | | | boolean biggerThan(IShape) | | | boolean
 * biggerThan(IShape) | | | boolean contains(CartPt) | | | boolean
 * contains(CartPt) | | +----------------------------+ |
 * +----------------------------+ +----+ +-------------------------+ | | v v
 * +-----------------------+ | CartPt | +-----------------------+ | int x | |
 * int y | +-----------------------+ | double distToOrigin() | | double
 * distTo(CartPt) | +-----------------------+
 */
...
class Circle implements IShape {
   ...
   * 
   * ... this.area() ... -- double ... this.distToOrigin() ... -- double ...
   * this.grow(int inc) ... -- IShape ... this.biggerThan(IShape that) ... --
   * boolean ... this.contains(CartPt pt) ... -- boolean
   */
  // to compute the area of this shape
  public double area() {
...
class ExamplesShapes {
  ...
  boolean testDistToOrigin(Tester t) {
    return t.checkInexact(this.pt1.distToOrigin(), 0.0, 0.001)
