...
val test120 = cumulative_sum [12,27,13] = [12,39,53]
val test121 = cumulative_sum [12] = [12]
					
val test130 = number_in_months_challenge ([(2012,2,28),(2013,12,1),(2011,3,31),
					   (2011,4,28)], [2,3,4]) = 3
val test131 = number_in_months_challenge ([(2012,2,28),(2013,12,1),(2011,3,31),
					   (2011,4,28)], [2,3,4,3,2,3,4,3]) = 3
val test132 = dates_in_months_challenge ([(2012,2,28),(2013,12,1),(2011,3,31),
					  (2011,4,28)], [2,3,4]) = [(2012,2,28),(2011,3,31),(2011,4,28)]
val test133 = dates_in_months_challenge ([(2012,2,28),(2013,12,1),(2011,3,31),
					  (2011,4,28)], [2,3,4,3,2]) = [(2011,4,28),(2011,3,31),(2012,2,28)]

val test140 = reasonable_date((2017,12,31)) = true
val test141 = reasonable_date((2017,1,1)) = true
val test142 = reasonable_date((2017,0,1)) = false
val test143 = reasonable_date((0,1,1)) = false
val test144 = reasonable_date((2017,2,29)) = false
val test145 = reasonable_date((2017,2,28)) = true
val test146 = reasonable_date((2016,2,29)) = true
val test147 = reasonable_date((0,2,29)) = false
val test148 = reasonable_date((1600,2,29)) = true
