...
(* Helper function to perform geometric shift translation on geometry values *)
fun shift_value (dx, dy, v) =
    case v of
        NoPoints => NoPoints
      ...
      | _ => raise Impossible "shift_value evaluated a non-value shape"
...
fun eval_prog (e,env) =
    case e of
      ...
      | Shift(dx, dy, e1) => shift_value(dx, dy, eval_prog(e1, env)) (* CHANGE: Add a case for Shift expressions *)
