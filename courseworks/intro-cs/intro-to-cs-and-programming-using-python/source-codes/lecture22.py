...
#         if not N == L_N[0]:
#             print(
#                 f'    {t/prev_time_brute:.2f} times more than for 10 times fewer elements')
#         prev_time_brute = t
...
#     if not N == L_N[0]:
#         print(
#             f'    {t/prev_time_binary:.2f} times more than for 10 times fewer elements')
#     prev_time_binary = t
...
#     if not N == L_N[0]:
#         print(
#             f'    {t/prev_time_builtin:.2f} times more than for 10 times fewer elements')
#     prev_time_builtin = t
