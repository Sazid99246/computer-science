...
from lecture20_helpers import gpsDistance
...
r = RunWorkout('9/30/2021 1:35 PM', '9/30/2021 3:57 PM',
               100)  # uses 200 cal_per_hr
sw = SwimWorkout('9/30/2021 1:35 PM', '9/30/2021 1:57 PM',
                 100)  # uses 400 cal_per_hr
...
run1 = RunWorkout('9/30/2021 1:35 PM', '9/30/2021 3:57 PM',
                  100, route_gps_points=points)
# print(f'Cals with route points: {run1.get_calories()}')

run2 = RunWorkout('9/30/2021 1:35 PM', '9/30/2021 3:57 PM',
                  100)  # 100 is elevation
