...
class TestPS4A(unittest.TestCase):
    ...
    def test_tree_height(self):
        ...
        self.assertEqual(
            st_tr1, answers[0], "Expected {} but got {}".format(answers[0], st_tr1))
        self.assertEqual(
            st_tr2, answers[1], "Expected {} but got {}".format(answers[1], st_tr2))
        self.assertEqual(
            st_tr3, answers[2], "Expected {} but got {}".format(answers[2], st_tr3))
